...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Rene Bustamante.</span> I'm a{" "}
        <span className="font-bold">Full Stack Developer</span> and{" "}
        <span className="font-bold">AWS Architect.</span> I started with Python automation, now combining AI and blockchain for smarter, secure data solutions.
      </motion.h1>
      ...
      >
        <a
          ...
          href="https://github.com/renesweet24"
          target="_blank"
        >
        ...
        <a
          ...
          href="https://www.linkedin.com/li/connectrenesweet/"
          target="_blank"
        >
